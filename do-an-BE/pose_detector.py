...
#tập trung nhiều về chức năng, cách giải quyết, lựa chọn các tham số

#xử lý chém như nào, nghiêng người như nào, chém trúng như nào

#1 giới thiệu

# phân tích thiết kế chức năng, dựa trên game gì, nên game này có chức nanngw gì, các user có chức năng gì

# công nghệ sử dụng GIẢI PHÁP, ngrok, xử lý vị trí như nào , tập trung computer vision

# kết quả thựcnghee, LÝ DO LỰA CHỌN, hình ảnh trong game, đưa ra lựa chọn chức năng game, phân vân, không lấy beat bằng AI
